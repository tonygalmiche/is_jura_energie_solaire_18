...
class IsCentrale(models.Model):
    ...
    localisation_google_maps_url = fields.Char("Maps", compute='_compute_localisation_google_maps_url', readonly=True)
    ...
    is_chantier_en_cours       = fields.Boolean("Chantier en cours", default=True)
